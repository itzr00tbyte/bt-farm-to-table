    ...
    <div className="relative h-screen w-full overflow-hidden" id="hero-carousel">
      <div className="carousel-container relative h-full">
        <div className="carousel-slide absolute inset-0 transition-opacity duration-1000 opacity-100">
          <img src="https://raw.githubusercontent.com/yourusername/your-repo/main/Images/Fruits%20Powders/banana%20powder.jpg" alt="Banana Powder" className="object-cover w-full h-full" />
          <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        </div>
        <div className="carousel-slide absolute inset-0 transition-opacity duration-1000 opacity-0">
          <img src="https://raw.githubusercontent.com/yourusername/your-repo/main/Images/Veg%20Powders/beetroot.webp" alt="Beetroot Powder" className="object-cover w-full h-full" />
          <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        </div>
        <div className="carousel-slide absolute inset-0 transition-opacity duration-1000 opacity-0">
          <img src="https://raw.githubusercontent.com/yourusername/your-repo/main/Images/Dehydrated%20Veg/carrot%20dehydrated.avif" alt="Dehydrated Carrot" className="object-cover w-full h-full" />
          <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        </div>
      </div>
