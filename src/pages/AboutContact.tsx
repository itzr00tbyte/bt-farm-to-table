            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-foreground">We never compromise on the quality of our products.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-primary">Sustainability</h3>
                  <p className="text-foreground">Environmental responsibility is at our core.</p>
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-primary">Community</h3>
                  <p className="text-foreground">Supporting local farmers and communities.</p>
                </div>
              </div>
            </div>
          </div>
